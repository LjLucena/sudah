...
<div class="row"  style="margin-top:20px;margin-bottom:20px;">
    <div class="col-md">
      ...
      <a href="/branch/appt/Pending" class="btn btn-outline-danger {{$status == 'Pending' ? 'active' : ''}}">Pending</a>
      <a href="/branch/appt/Approved" class="btn btn-outline-info {{$status == 'Approved' ? 'active' : ''}}">Approved</a>
      <a href="/branch/appt/Done" class="btn btn-outline-success {{$status == 'Done' ? 'active' : ''}}">Completed</a>
      <a href="/branch/appt/Cancelled" class="btn btn-outline-secondary {{$status == 'Cancelled' ? 'active' : ''}}">Cancelled</a>
    </div>
</div>
<div class="row">
    <div class="col-12">
