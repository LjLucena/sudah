    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="ui/assets/img/products/collar4.png" alt="Card image cap" id="product-detail">
                </div>
                <div class="row">
                    <!--Start Controls-->
                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="ui/assets/img/products/collar4.png" alt="Product Image 1">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/collar2.png" alt="Product Image 2">
                                    </a>
                                </div>
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/collar3.png" alt="Product Image 3">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-7 mt-5">
            <div class="card">
                <div class="card-body">
                    <h1 class="h2">Pet Reflective Collar With Bell</h1>
                    <br/><br/>
                    <h6><b>Features:</b></h6>
                    <ul>
                    <li>100% brand new and high quality.</li>
                    <li>Bright light can be seen from far away, this is not only for fashion, this collar also keeps your pet safe while walking at night.</li>
                    <li>Drivers can see your pet far away to prevent accident.</li>
                    <li>Adjustable strap, comes with a bell.</li>
                    <li>Plastic release buckle design, easy to take on and off.</li>
                    <li>Very durable</li>
                    <li>Suitable for all kinds of pets</li>
                    </ul>
                    <br/><br/>
...
<div div="row">
    <ul class="pagination pagination-lg justify-content-end">
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="gallon">Previous</a>
        </li>
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="pet_leash" tabindex="-1">Next</a>
        </li>
    </ul>
</div>
