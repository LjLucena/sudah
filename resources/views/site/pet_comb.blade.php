    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="ui/assets/img/products/comb1.png" alt="Card image cap" id="product-detail">
                </div>
                <div class="row">
                    <!--Start Controls-->
                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="ui/assets/img/products/comb1.png" alt="Product Image 1">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/comb2.png" alt="Product Image 2">
                                    </a>
                                </div>
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/comb3.png" alt="Product Image 3">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-7 mt-5">
            <div class="card">
                <div class="card-body">
                    <h1 class="h2">Pet Hair Slicker Comb</h1>
                    <br/><br/>
                    <h6><b>Features:</b></h6>
                    <ul>
                        <li>Removes dead loose hair and shredding pet hair.</li>
                        <li>Used for massage your pets and pets will feel comfortable under the brush's motion.</li>
                        <li>Keeps your pet well-groomed and gentle care of the pet's hair.</li>
                        <li>Comfortable handle bar, easy to hold and use.</li>
                        <li>Include a comb scoop, convenient to use.</li>
                        <li>Dismountable design for easy cleaning.</li>
                    </ul>
                    ...
                    <ul>
                        <li>Length: 1.5cm</li>
                        <li>Head width: 5cm</li>
                        <li>Weight: 40g</li>
          
                        <li>Head length: 10cm</li>
                        <li>Color: Red</li>
                    </ul>
                </div>
            </div>
...
<div div="row">
    <ul class="pagination pagination-lg justify-content-end">
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="litter_box">Previous</a>
        </li>
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="cat_condo" tabindex="-1">Next</a>
        </li>
    </ul>
</div>
