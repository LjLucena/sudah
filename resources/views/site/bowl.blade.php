    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="ui/assets/img/products/bowl1.png" alt="Card image cap" id="product-detail">
                </div>
                <div class="row">
                    <!--Start Controls-->
                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="ui/assets/img/products/bowl1.png" alt="Product Image 1">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/bowl2.png" alt="Product Image 2">
                                    </a>
                                </div>
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/bowl3.png" alt="Product Image 3">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-7 mt-5">
            <div class="card">
                <div class="card-body">
                    <h1 class="h2">Stainless Steel Bowl</h1>
                    <br/><br/>
                    <h6><b>Features:</b></h6>
                    <ul>
                    <li>15cm: Lower opening is 15cm, the diameter of the upper opening is 10.5cm and the height is 3.5cm</li>
                    <li>18cm: Lower opening diameter 18cm upper opening diameter 13.5cm height 4.5cm</li>
                    <li>22cm: Lower opening diameter 22cm Upper opening diameter 16cm height 4.8cm</li>
                    <li>26cm: Lower opening diameter 26cm Upper opening diameter 19.5cm height 5.4cm</li>
                    <li>30cm: Diameter of lower opening 30cm diameter of upper opening 22cm height 7cm</li>
                    </ul>
...
<div div="row">
    <ul class="pagination pagination-lg justify-content-end">
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="pet_leash">Previous</a>
        </li>
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="bed" tabindex="-1">Next</a>
        </li>
    </ul>
</div>
