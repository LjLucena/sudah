    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="ui/assets/img/products/litter1.png" alt="Card image cap" id="product-detail">
                </div>
                <div class="row">
                    <!--Start Controls-->
                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="ui/assets/img/products/litter1.png" alt="Product Image 1">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/litter2.png" alt="Product Image 2">
                                    </a>
                                </div>
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/litter3.png" alt="Product Image 3">
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul>
                        ...
                        <li>Made of environmentally friendly PP, safe for your pet.</li>
                        <li>Open top Cat litter box is designed to offer Cat plenty of room and quick accessibility.</li>
                        <li>Side and back of the litter container are high enough to keep litter from scattering on the floor.</li>
                        <li>Include a litter scoop, convenient to use.</li>
...
<div div="row">
    <ul class="pagination pagination-lg justify-content-end">
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="bed">Previous</a>
        </li>
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="pet_comb" tabindex="-1">Next</a>
        </li>
    </ul>
</div>
