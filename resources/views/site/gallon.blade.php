    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="ui/assets/img/products/gallon1.png" alt="Card image cap" id="product-detail">
                </div>
                <div class="row">
                    <!--Start Controls-->
                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="ui/assets/img/products/gallon1.png" alt="Product Image 1">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/gallon2.png" alt="Product Image 2">
                                    </a>
                                </div>
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/gallon3.png" alt="Product Image 3">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-7 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6><b>Features:</b></h6>
                    <ul>
                    <li>Made of good quality plastic material, environment friendly, non-toxic and no smell, safe to use.</li>
                    <li>3.8L large capacity, which can provide enough food/water for pet for several days, and you can check the remaining of food clearly.</li>
                    <li>Easy to use, just putting food/water into the device, then it can automatic feed through the principle of gravity to ensure a consistent supply of food/water.</li>
                    </ul>
                    <br/><br/>
                    <h6><b>Specifications:</b></h6>
                    <ul>
                    <li>Material: PP， Straw</li>
                    <li>Bucket size: 17*23cm</li>
                    <li>Base size: 17.5*31.5*5.5cm</li>
                    <li>Capacity: 3.8L</li>
                    </ul>
                </div>
            </div>
...
<div div="row">
    <ul class="pagination pagination-lg justify-content-end">
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="carrier">Previous</a>
        </li>
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="collar" tabindex="-1">Next</a>
        </li>
    </ul>
</div>
