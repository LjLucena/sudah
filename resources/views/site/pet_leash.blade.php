    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="ui/assets/img/products/leash1.png" alt="Card image cap" id="product-detail">
                </div>
                <div class="row">
                    <!--Start Controls-->
                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="ui/assets/img/products/leash1.png" alt="Product Image 1">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/leash2.png" alt="Product Image 2">
                                    </a>
                                </div>
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/leash3.png" alt="Product Image 3">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-7 mt-5">
            <div class="card">
                <div class="card-body">
                    <h1 class="h2">Adjustable Pet Leash </h1>
                    <br/><br/>
                    <h6><b>Features:</b></h6>
                    <ul>
                    <li>100% brand new and high quality.</li>
                    <li>Plastic eye-splice. step in, easy on and off.</li>
                    <li>Steel snap buckle and D-ring.</li>
                    <li>Adjustable strap, comes with a bell.</li>
                    <li>Very durable</li>
                    <li>Suitable for small pets</li>
                    </ul>
                    <br/><br/>
                    <h6><b>Specifications:</b></h6>
                    <ul>
                    <li>Material: Nylon</li>
                    <li>Size: 120cm*1cm</li>
                    <li>Tough</li>
                    <li>Durable</li>
                    <li>Soft</li>
                    </ul>
...
<div div="row">
    <ul class="pagination pagination-lg justify-content-end">
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="collar">Previous</a>
        </li>
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="bowl" tabindex="-1">Next</a>
        </li>
    </ul>
</div>
