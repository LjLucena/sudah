              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                      ...
                      <input type="password" name="p" id="p" autocomplete="new-password" class="form-control" placeholder="Enter Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                  </div>
                  <div class="col-md-4">
