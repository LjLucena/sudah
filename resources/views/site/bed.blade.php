    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="ui/assets/img/products/bed1.png" alt="Card image cap" id="product-detail">
                </div>
                <div class="row">
                    <!--Start Controls-->
                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="ui/assets/img/products/bed1.png" alt="Product Image 1">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/bed2.png" alt="Product Image 2">
                                    </a>
                                </div>
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/bed3.png" alt="Product Image 3">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-7 mt-5">
            <div class="card">
                <div class="card-body">
                    <h1 class="h2">Pet Cozy Bed</h1>
                    <p>550-750php</p>
                    <br/><br/>
                    <h6><b>Features:</b></h6>
                    <ul>
                    <li>Keep your pet comfortable and warm for  4 seasons.</li>
                    <li>Easy to wash, and it has beautiful shape.</li>
                    <li>Easy to move around your house.</li>
                    <li>Suitable for small and medium dog cat</li>
                    <li>The bed bottom is waterproof, non-slip and moisture-proof for the oxford cloth material.</li>
                    </ul>

                    <br/><br/>
                    <h6><b>Specifications:</b></h6>
                    <ul>
                    <li>Dog and Cat Bed Mat</li>
                    <li>Applies to small, medium large dog, puppy and chihuahua.</li>
                    <li>Material: High quality PP cotton, durable, soft and skin-friendly.</li>
                    <li>Pattern: Animal solid striped mat.</li>
                    </ul>

                    <br/><br/>
                    <h6><b>Available Sizes:</b></h6>
                    <ul>
                    <li>Medium 50*38*15cm</li>
                    <li>Large 60*45*15cm</li>
                    <li>Extra Large 80*60*15cm</li>
                    </ul>
...
<div div="row">
    <ul class="pagination pagination-lg justify-content-end">
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="bowl">Previous</a>
        </li>
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="litter_box" tabindex="-1">Next</a>
        </li>
    </ul>
</div>
