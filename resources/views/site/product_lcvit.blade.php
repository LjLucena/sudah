    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="ui/assets/img/products/lcvit1.png" alt="Card image cap" id="product-detail">
                </div>
                <div class="row">
                    <!--Start Controls-->
                        ...
                        <div class="carousel-inner product-links-wap" role="listbox">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#">
                                            <img class="card-img img-fluid" src="ui/assets/img/products/lcvit1.png" alt="Product Image 1">
                                        </a>
                                    </div>
                                    <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/lcvit2.png" alt="Product Image 2">
                                    </a>
                                </div>
                                <div class="col-4">
                                    <a href="#">
                                        <img class="card-img img-fluid" src="ui/assets/img/products/lcvit3.png" alt="Product Image 3">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-7 mt-5">
            <div class="card">
                <div class="card-body">
                    <h1 class="h2">LC Vit Multi-vitamins </h1>
                    <p>180php</p>
                    <br/><br/>
                    <h6><b>Description</b></h6>
                    <p>Prevents & treats vitamin deficiencies</p>
                    <p>Helps improve appetite & general health</p>
                    <p>Multivitamins for dogs, cats, rabbits, hamsters & chinchilla</p>
                    <br/><br/>
                    <p>Improves appetite and general health. Prevents and treats vitamin deficiencies during stress conditions in dogs, cats, rabbits, hamsters and chinchilla.</p>
                </div>
            </div>
        </div>
        </div>
...
<div div="row">
    <ul class="pagination pagination-lg justify-content-end">
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="product_furmagic">Previous</a>
        </li>
        <li class="page-item">
            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0" href="product_mondex" tabindex="-1">Next</a>
        </li>
    </ul>
</div>
